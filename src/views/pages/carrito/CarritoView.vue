    ...
    <section class="wrapper bg-light mb-5">
        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center" v-if="identificacionView">
                ...
                <IdentificacionCarrito @avanzarregistro="nextdetallesfacturacion" />
                
            </div>

            <div class="row" v-if="pago">

                <DetallesFacturacion @avanzarconfirm ="nextconfirmacion" />
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 d-flex justify-content-end p-5">
                                        ...
                                        <a :href="urlpago" class="btn btn-primary">Finalizar</a>
