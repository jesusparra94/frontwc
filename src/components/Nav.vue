          ...
          <div class="container flex-lg-row flex-nowrap align-items-center">
            ...
            <div class="navbar-collapse offcanvas-nav">
             ...
             <div class="offcanvas-header d-lg-none d-xl-none">
                <a href="./index.html"><img src="@/assets/imagenes/logoWeb.png" width="320px" alt="" /></a>
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#!">Servicios</a>
                  
                </li>
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#!">Contacto</a>
