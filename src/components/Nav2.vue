...
<header class="wrapper">
      <nav class="navbar navbar-expand-lg center-nav transparent navbar-light caret-none" style="box-shadow: 0px 0.5px 3px black;">
        <div class="container flex-lg-row flex-nowrap align-items-center">
          ...
          <div class="navbar-collapse offcanvas-nav">
            <div class="offcanvas-header d-lg-none d-xl-none">
              <router-link to="/"><img src="@/assets/img/logo-light.png" srcset="@/assets/img/logo-light@2x.png 2x" alt="" /></router-link>
